...
import scheduleSearch from '../functions/utills/schedule';
...
export async function scheduleJob(req: Request, res: Response) {
    try {
        ...
        scheduleSearch(rule, scheduleId, { name, country, content_languages, filtterStart_date, filtterEnd_date, querry, ad_status_type, reach, ad_type, media_type, publisher_platforms, Nextforward_cursor, Nextbackward_cursor, Nextcollation_token, uid, access_token, session, page });
