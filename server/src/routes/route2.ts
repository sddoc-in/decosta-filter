...
import { register, registerAdmin } from "../controller-z/register";
import { login, resetPassword, sendEmailOTP, validateOTP } from "../controller-z/login";
import { deleteSearch, getSearchBySearchId, getSearchesByUser, scheduleJob, startSearching, stopSearch, storeSearch, getScheduledByUser, stopScheduleSearch, deleteScheduleSearch } from "../controller-z/searches";
import { getAllResultsByUser } from "../controller-z/results";
import { deleteUser, getAllAdmins, getAllUsers, getUser, updateUser } from "../controller-z/users";
import { getNumberOfResultsOnDailyBasis, getNumberOfSearchesPerUser, getSearchCountOnDailyBasis } from "../controller-z/getGraphs";
import { getSettings, updateSettings } from "../controller-z/admin";
import {getUserProfile} from "../controller-z/profileData";
