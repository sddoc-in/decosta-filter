  ...
  return (
    ...
    {props.label && (
      ...
      <input
        ...
        className={
          "input rounded-lg text-[14px] text-black w-full font-medium disabled:bg-white disabled:text-black placeholder:font-normal placeholder:text-[#000] bg-white focus:outline-none  my-1 "
        }
